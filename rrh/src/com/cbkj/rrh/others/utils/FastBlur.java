...
public class FastBlur {
	 ...
	 * 
	 * @todo:制作图片
	 * @date:2015-7-26 下午1:35:11
	 * @author:hg_liuzl@163.com
	 * @params:@param sentBitmap 原图片
	 * @params:@param radius 模糊程度
	 * @params:@param canReuseInBitmap 是否得胜原图片
	 * @params:@return
	 */
