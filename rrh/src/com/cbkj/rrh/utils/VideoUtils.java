...
public class VideoUtils {
	...
	public static void initVideoThumbNail(String videoPath,ImageView ivThumb){
		Bitmap fristFrameOfVideo = ThumbnailUtils.createVideoThumbnail(videoPath,Thumbnails.MINI_KIND);//创建视频缩略图(240*320)
	...
	public static Bitmap getVideoThumbNail(String videoPath){
		return ThumbnailUtils.createVideoThumbnail(videoPath,Thumbnails.MINI_KIND);//创建视频缩略图(240*320)
	}
