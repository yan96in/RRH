package com.cbkj.rrh.view.slidingmenu.lib;
...
import com.cbkj.rrh.view.slidingmenu.lib.SlidingMenu.OnClosedListener;
import com.cbkj.rrh.view.slidingmenu.lib.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
	...
	/**
	 * 页面滚动 This method will be invoked when the current page is scrolled,
	 * either as part of a programmatically initiated smooth scroll or a user
	 * initiated touch scroll. If you override this method you must call through
	 * to the superclass implementation (e.g. super.onPageScrolled(position,
	 * offset, offsetPixels)) before onPageScrolled returns.
	 * 
	 * @param position
...
//		float i = mScrollX - left;
//		int behindWidth = getBehindWidth();
//		float abs = Math.abs(mScrollX - mContent.getLeft()) / getBehindWidth();
