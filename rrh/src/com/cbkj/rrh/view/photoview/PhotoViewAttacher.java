...
import com.cbkj.rrh.view.photoview.gestures.GestureDetector;
import com.cbkj.rrh.view.photoview.gestures.OnGestureListener;
import com.cbkj.rrh.view.photoview.gestures.VersionedGestureDetector;
import com.cbkj.rrh.view.photoview.log.LogManager;
import com.cbkj.rrh.view.photoview.scrollerproxy.ScrollerProxy;

public class PhotoViewAttacher implements IPhotoView, View.OnTouchListener, OnGestureListener, android.view.GestureDetector.OnDoubleTapListener, ViewTreeObserver.OnGlobalLayoutListener
{
	...
	public final boolean onTouch(View v, MotionEvent ev)
	{
		...
		if (mZoomEnabled && hasDrawable((ImageView) v))
		{
			...
			case ACTION_UP:
				...
				// if (null != rect)
				// {
				// v.post(new AnimatedZoomRunnable(getScale(), mMidScale,
